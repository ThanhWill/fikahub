...
export const MEGAMENU_TEMPLATES: NavItemType[] = [
  {
    ...
    children: [
      ...
      { id: ncNanoId(), href: '/page-test', name: 'Page Test' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: ncNanoId(), href: '/collection-test', name: 'Collection Test' },
      { id: ncNanoId(), href: '/product-detail', name: 'Product Page 1' },
      { id: ncNanoId(), href: '/product-detail-2', name: 'Product Page 2' },
      { id: ncNanoId(), href: '/product-detail-test', name: 'Product Page Test' },
